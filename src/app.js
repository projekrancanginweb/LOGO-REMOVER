...
const TEXT = {
    ...
    size: 'Ukuran',
    watermark: 'Watermark terdeteksi',
    position: 'Posisi',
    status: 'Status',
    removed: 'Watermark telah dihapus',
    skipped: 'Tidak ada watermark terdeteksi, gambar asli dipertahankan',
    unsupported: 'Browser tidak mendukung salin gambar',
    copied: 'Berhasil disalin!',
    copy: 'Salin hasil',
    copyFailed: 'Gagal menyalin',
    unsupportedFile: 'Silakan pilih gambar JPG, PNG, WebP, atau video MP4/WebM/MOV.',
    fileTooLarge: 'Input debugging gambar tidak menerima gambar melebihi 20MB. Video akan diteruskan ke halaman debugging video.',
    skippedLargeImages: 'Gambar melebihi 20MB dilewati.',
    handoffVideo: 'Memasuki alur debugging video...',
    progress: 'Progres pemrosesan',
    pending: 'Menunggu diproses',
    loadingImage: 'Membaca gambar...',
...
async function routeVideoFile(file) {
    try {
        ...
        hideLoading();
        console.error(error);
        setStatusMessage(error.message || 'Gagal memasuki alur debugging video, silakan buka halaman video lalu pilih ulang file.', 'warn');
    }
}
...
async function consumePendingImageHandoff() {
    ...
    try {
        ...
        setStatusMessage(error.message || 'Gagal membaca sementara gambar, silakan pilih ulang file.', 'warn');
    }
}
