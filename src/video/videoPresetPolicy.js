...
export function getRelocatedReviewPresetConfig() {
    return {
        id: 'relocated-review',
        label: 'Proses Otomatis AI',
        description: 'Mendeteksi posisi watermark secara otomatis dan membersihkannya menggunakan model AI tanpa perlu penyetelan manual.',
...
export function getStandardAutoPresetConfig() {
    return {
        id: 'standard-auto',
        label: 'Proses Otomatis AI',
        description: 'Secara default menggunakan model AI lokal untuk memproses watermark Gemini/Veo di sudut kanan bawah.',
        alphaGain: DEFAULT_AUTO_ALPHA_GAIN,
        adaptiveAlpha: false,
        highQualityCleanup: DEFAULT_HIGH_QUALITY_CLEANUP,
